                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='relative'>
                            ...
                            <input type='text' placeholder='Enter role'
                                className='w-full pl-12 pr-4 py-3 bg-white text-gray-800 placeholder-gray-400 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
                        ...
                        <select value={mode}
                            ...
                            className='w-full py-3 px-4 bg-white text-gray-800 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'>
